riscv-none-embed-gcc -march=rv32ec -mabi=ilp32e -static --specs=nosys.specs -ffreestanding -nostartfiles -I..\..\header -Wl,-T..\..\linker\qspinor.ld -Wl,-Map=..\..\out.map start.s main.c -o ..\..\out.elf
