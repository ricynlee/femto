riscv-none-embed-gcc -g -march=rv32ec -mabi=ilp32e -static --specs=nosys.specs -ffreestanding -nostartfiles -I..\..\sdk -Wl,-T..\..\linker\rom.ld -Wl,-Map=..\..\out.map start.s init.c main.c ..\..\sdk\sdk.c ..\..\sdk\bsdk.c -o ..\..\out.elf -Os
