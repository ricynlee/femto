riscv-none-embed-gcc -march=rv32ec -mabi=ilp32e -static --specs=nosys.specs -ffreestanding -nostartfiles -I..\..\sdk -I..\ -Wl,-T..\..\linker\rom.ld -Wl,-Map=..\..\out.map ..\start.s main.c ..\..\sdk\interrupt.c -o ..\..\out.elf
